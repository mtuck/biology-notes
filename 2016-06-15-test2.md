...
### DNA Replication
1. The sides of DNA pull apart
2. __DNA polymerase__(enzyme protein) joins free nucleotides with exposed strands
 * ligase seals strand
 * __primer__ bond spontaneously to exposed complementary segments of dna
3. Each double stranded DNA produced is in its own chromatid (recall zipper model) (not diploid)
